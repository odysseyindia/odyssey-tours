...
translationKey: taj-malabar-resort-and-spa
bookthrough: ''
mailto: ''
...
accessBus: ''
advantage: >-
  On an island - Rooms Overlooking the scenic backwaters - 10 Minutes by ferry
  from the main city & old Cochin.
rooms: 96
rates:
  ...
  - roomType: Premium Sea View Room
    ...
    notes: 0
    agentCommission: 0
  - roomType: Executive Suite 1 Bedroom Seaview
    mealPlan: Room only
    mealPlanPT: ''
    currency: INR
    currencyPT: INR
    ...
    notes: 0
    agentCommission: 0
  - roomType: Luxury Suite 1 Bedroom Seaview
    mealPlan: Room only
    mealPlanPT: ''
    currency: INR
    currencyPT: INR
  ...
  - roomType: Superior Room
    ...
    defaultAc: 1
    specialPeriod: 0
    notes: Less Rs 500 between 01/12 - 10/12
    agentCommission: 0
  - roomType: Superior Harbour View Room
    mealPlan: Room only
    mealPlanPT: ''
